...
<div class="container " >
  <div class="row">
    ...
    <h1 class="text-secondary">Data Siswa</h1>
    <hr>
...
<div class="container positiion-fixed">
  <div class="row">
    <div class="col-6">
      ...
      <h4 class="text-primary"><i>Cari Data Siswa</i></h4>
            ...
            <div class="card m-2 bg-secondary" style="width: 20rem; float:left;">
                <div class="card-body">
                    ...
                    <ul style="list-style: none;">
                        ...
                        <li>
                          <td><a class="btn btn-warning mt-3" data-toggle="modal" data-target="#oop">hapus</a><a class="btn btn-dark mt-3" href="edit.php?id_siswa=<?php echo $key["id_siswa"]; ?>">edit</a></td>
                        </li>
                    </ul>
                </div>
            </div>
